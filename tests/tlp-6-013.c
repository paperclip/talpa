...
int main(int argc, char *argv[])
{
    ...
    ret = ioctl(fd,TALPA_TEST_CACHE_EXTALLOW,&tf);
    ...
    ret = ioctl(fd,TALPA_TEST_CACHE_EXTDENY,&tf);
    ...
    ret = ioctl(fd,TALPA_TEST_CACHE_EVAL,&tf);
    ...
    {
        fprintf(stderr,"Cache delete test error!\n");
        close(fd);
        return 1;
    }
