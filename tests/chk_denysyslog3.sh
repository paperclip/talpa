...
./chk_denysyslog3 "Timeout occurred while opening /bin/bash on behalf of process chk_denysyslog3[" 1 5
./chk_denysyslog3 "Error occurred while opening /bin/bash on behalf of process chk_denysyslog3[" 1 6
...
./chk_denysyslog3 "Timeout occurred while closing /bin/bash on behalf of process chk_denysyslog3[" 2 5
./chk_denysyslog3 "Error occurred while closing /bin/bash on behalf of process chk_denysyslog3[" 2 6
...
./chk_denysyslog3 "Timeout occurred while executing /bin/bash on behalf of process chk_denysyslog3[" 3 5
./chk_denysyslog3 "Error occurred while executing /bin/bash on behalf of process chk_denysyslog3[" 3 6
